...
class StorageService extends GetxController {
  //Kullanmadan önce initial edeceğimiz için late kullaıyoruz
  ...
  //getValue<String>(token); gibi
  //instance olduğpu için eşittir kullanıyoruz
  T? getValue<T>(String key) {
    try {
      ...
      print("Veri storage'dan çekilirken hata oluştu");
      return null;
    }
  }
